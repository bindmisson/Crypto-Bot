...
//   const response = await fetch(`http://20.193.147.19:8080/getChats?key=${document.cookie.slice(4)}`)
...
//   await fetch(`http://20.193.147.19:8080/sendQuery?key=${document.cookie}&msg=${msg}`)
//   setreload(true)
//   msg=''
// }
