...
function SignupLogin() {
  ...
  if (document.cookie.charAt(0).toString()=='k'){
    document.location.href='http://192.168.50.189:3000/home'
  }
    ...
    if (true) {
      ...
      async function checkUser() {
        ...
        const response = await fetch(
          `http://192.168.50.189:8080/signup/checkUser?user=${e.target.value}`,
          {
            headers: {
  ...
  function onPassChange(e) {
    if (true) {
      ...
      async function checkPass() {
        const response = await fetch(
          `http://192.168.50.189:8080/signup/checkPass?pass=${pass}`,
          {
            headers: {
              "Content-Type": "application/json",
              accepts: "application/json",
        ...
        <div className="signbox">
          {signup ? (
            <div className="authBox">
              <h2>Sign Up</h2><br />
              <form action="http://192.168.50.189:8080/signup" method="post" className="signupform">
            ...
            <div className="authBox">
              <h2>Login</h2><br />
              <form action="http://192.168.50.189:8080/login" method="post" className="loginform">
